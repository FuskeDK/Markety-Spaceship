...
const cases = [
  ...
  },
  {
    ...
    solution:
      "We built a cold email outreach system targeting mid-market finance directors, paired with a 5-step nurture sequence that moved prospects from cold to qualified lead automatically.",
    metrics: [
      { label: "Pipeline added",       before: "£0 outbound", after: "£68K / mo", delta: "From £0" },
      { label: "Qualified leads / mo", before: "0 / mo",      after: "14 / mo",   delta: "+14" },
