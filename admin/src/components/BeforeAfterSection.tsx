      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-0">
          <motion.div
            ...
            className="bg-muted/50 border border-border rounded-lg md:rounded-r-none md:rounded-l-2xl p-8"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.4 }}
            className="bg-purple-deep border border-purple-deep rounded-lg md:rounded-l-none md:rounded-r-2xl p-8"
          >
