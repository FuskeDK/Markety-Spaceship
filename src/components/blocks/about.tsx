    ...
    <div>
      ...
      <section className="container mt-24 max-w-5xl lg:mt-32">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {["We learn your business", "We build your system", "We launch and optimise", "Leads arrive, you close"].map((step, i) => (
            <div key={i} className="rounded-2xl border bg-card p-6">
              <div className="mb-4 inline-flex size-8 items-center justify-center rounded-full bg-purple-100 text-sm font-bold text-purple-700 dark:bg-purple-950 dark:text-purple-300">
                {i + 1}
              </div>
      ...
      <section className="container mt-24 max-w-5xl lg:mt-32">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {VALUES.map((value) => {
            ...
            return (
              <div key={value.title} className="flex gap-5 rounded-2xl border bg-card p-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 text-sm leading-relaxed">{value.description}</p>
                </div>
              </div>
            );
          })}
