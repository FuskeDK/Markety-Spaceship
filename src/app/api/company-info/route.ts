...
//   1. Auto-creates a new row in the `clients` table with a unique dashboard token.
//   2. Links the optional `contact_token` so api/check-submission can detect resubmissions.
//   3. Emails the admin with the full submission.
//   4. Emails the customer a "your dashboard is ready" confirmation.
